...
This folder is the region-default content layer for `reg09`.
...
- `regions/reg09/data/primary-assets.json`
- `regions/reg09/data/primary.json`
- `regions/reg09/data/footer.json`
- `regions/reg09/data/primaryending.json`
- `regions/reg09/assets/primary/manifest.json`
- `regions/reg09/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg09`.
