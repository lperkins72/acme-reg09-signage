...
```text
?tenant=acme&region=reg09&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg09&device=nuc-001
```
...
5. test one launcher such as `/devices/reg09/nuc-001.html`
